...
class HomeViewModel extends ChangeNotifier{
  ...
  Response<List<FurnitureModel>> featuredFurnitureListUseCase = Response<List<FurnitureModel>>();
  ...
  void setFeaturedFurnitureListUseCase(Response<List<FurnitureModel>> response) {
